...
import com.ahsj.userinfor.common.tag.AHSJSelectTagProcessor;
import com.ahsj.userinfor.common.tag.dialect.AHSJSelectDialect;
...
public class ThymleafConfig {
    ...
    public SpringTemplateEngine templateEngine() {
        ...
        engine.setEnableSpringELCompiler(true);
        engine.setTemplateResolver(templateResolver());
        engine.addDialect(new AHSJSelectDialect());
        return engine;
    }
    ...
    public ThymeleafViewResolver viewResolver(){
        ...
        viewResolver.addStaticVariable("CTX","/accounts");
        return viewResolver;
    }
}
