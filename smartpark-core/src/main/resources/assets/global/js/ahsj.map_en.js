...
Lib.AMap.WalkingRender = function() {
    ...
    me.view.createOpenitemDiv = function(index, title, data, isDisplay) { //创建打开的div
        ...
        r.push("    <dt class=\"start\"><div class='beforedt'></div><div class='afterdt'></div><b>" + "Start Point" + "</b></dt>");
        //添加了a标签
        for (var i = 0, step; i < steps.length; i++) {
            step = steps[i];
            //IOS端让服务器去生成音频文件
        ...
        //     r.push(" </dt>");
        // }
        r.push("    <dt class=\"end\"><div class='beforedt'></div><b>" + "Destination" + "</b></dt>");
        r.push("</dl>");
        r.push("<div style='color:#8b1014' align=\"center\">Looks like you can scroll it！</div>")
        return r;
    }
