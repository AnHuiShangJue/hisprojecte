package com.ahsj.sysuserinfo.controller.smartparkcore;

import com.ahsj.sysuserinfo.controller.BaseOAController;
...
import com.ahsj.sysuserinfo.entity.dto.ParamVo;
import com.ahsj.sysuserinfo.services.MenuService;
...
@Controller
@RequestMapping("/api/sysuserinfo/menu")
public class MenuController extends BaseOAController {
    ...
    @ResponseBody
    public List<TreeEntity> treeCode(@RequestBody ParamVo paramVo) throws Exception {
        if (paramVo.getLv() == null) {
        ...
        return menuService.selectTreeCode(paramVo.getId());
    }
     ...
     * @Time 0:39
     **/
    @PostMapping("/layout/lstMenu.ahsj")
    @ResponseBody
    Map<String, String> listMenu(@RequestParam("id") Long id) {
        List<Menu> lstMenu = menuService.listSysMenu(id);
